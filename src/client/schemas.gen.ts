...
export const AccountSchema = {
    ...
    type: 'object',
    required: ['name', 'status', 'country', 'person_type', 'user_id'],
    title: 'Account'
} as const;

export const AccountCreateInSchema = {
    properties: {
        name: {
            type: 'string',
            title: 'Name'
    ...
    type: 'object',
    required: ['name', 'country', 'person_type'],
    title: 'AccountCreateIn'
} as const;
...
export const CountryIso2Schema = {
    type: 'string',
    enum: ['AR', 'BO', 'BR', 'CL', 'CO', 'CR', 'DO', 'EC', 'SV', 'GT', 'HN', 'MX', 'PA', 'PY', 'PE', 'UY'],
    title: 'CountryIso2'
} as const;
