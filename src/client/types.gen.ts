...
export type CountryIso2 = 'AR' | 'BO' | 'BR' | 'CL' | 'CO' | 'CR' | 'DO' | 'EC' | 'SV' | 'GT' | 'HN' | 'MX' | 'PA' | 'PY' | 'PE' | 'UY';
...
export type UsersCreateAccountData = {
...
export type UsersCreateAccountResponse = (Account);

export type UsersCreateAccountError = (HTTPValidationError);